...
namespace MVCDatabasePracNonCore.Models
{
    public class EmployeeModel
    {
        ...
        [Required(ErrorMessage="Your need to give us your first name.")]
        public string FirstName { get; set; }

        [Display(Name = "Last Name")]
        [Required(ErrorMessage = "Your need to give us your last name.")]
        public string LastName { get; set; }

        [DataType(DataType.EmailAddress)]
        [Display(Name = "Email Address")]
        [Required(ErrorMessage = "Your need to give us your email adrress.")]
